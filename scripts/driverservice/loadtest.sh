...
ssh $server_test sudo docker-compose -f ./ClientTestingTool/loadtest/docker-compose.yml run test_runner "./tests/driverService/driverservice.loadtest.yml" "--target http://10.123.252.250:5002"
